...
import { Box, Button, FormControl, Input, Link, Stack, SxProps, Typography } from '@mui/material'
import { setSearchKeyword } from 'pages/Grid/grid.slide'
...
function Header() {
  ...
  useEffect(() => {
    dispatch(setSearchKeyword(keywordDebound))
  }, [dispatch, keywordDebound])
  ...
  return (
    <Stack component="header" sx={styles.header}>
      ...
      <Box component="form" sx={styles.searchForm} onSubmit={handleOnFormSubmit}>
...
const styles: Styles = {
  header: {
    backgroundImage:
      'url(https://instantsearchjs.netlify.app/examples/react/e-commerce/cover.bc59a785.png)',
    minHeight: '368px',
